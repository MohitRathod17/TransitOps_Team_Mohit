...
class VehicleDocumentResponse(BaseConfigModel):
    id: int
    vehicle_id: int
    document_type: str
    file_path: str
...
class DriverDocumentResponse(BaseConfigModel):
    id: int
    driver_id: int
    document_type: str
    file_path: str
...
class TripResponse(BaseConfigModel):
    ...
    source_lng: Optional[Decimal] = None
...
class DashboardChartsResponse(BaseModel):
    utilization_trend: List[ChartPoint]
    fuel_costs: List[ChartPoint]
