...
# Security: Safety Officer and Fleet Manager can manage drivers.
driver_managers = RoleChecker(["Fleet Manager", "Safety Officer"])
...
async def create_driver(
    ...
    db: AsyncSession = Depends(get_db),
    current_user = Depends(driver_managers)
):
